...
export declare const appendFormControlItem: unique symbol;
export declare const appendNamedItem: unique symbol;
...
export declare const cacheID: unique symbol;
export declare const cachedResponse: unique symbol;
export declare const callbacks: unique symbol;
export declare const captureEventListenerCount: unique symbol;
...
export declare const connectToNode: unique symbol;
...
export declare const getAttributeName: unique symbol;
export declare const happyDOMSettingsID: unique symbol;
...
export declare const isValidPropertyName: unique symbol;
...
export declare const observedAttributes: unique symbol;
...
export declare const removeFormControlItem: unique symbol;
export declare const removeNamedItem: unique symbol;
export declare const removeNamedItemIndex: unique symbol;
export declare const removeNamedItemWithoutConsequences: unique symbol;
...
export declare const setNamedItemWithoutConsequences: unique symbol;
...
export declare const unobserve: unique symbol;
export declare const updateIndices: unique symbol;
export declare const updateOptionItems: unique symbol;
...
export declare const ownerWindow: unique symbol;
...
export declare const videoTracks: unique symbol;
...
export declare const registedClass: unique symbol;
