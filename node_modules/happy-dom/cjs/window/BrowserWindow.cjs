...
class BrowserWindow extends EventTarget_js_1.default {
    ...
    constructor(browserFrame, options) {
        ...
        const propertyDescriptors = Object.assign(Object.getOwnPropertyDescriptors(EventTarget_js_1.default.prototype), Object.getOwnPropertyDescriptors(BrowserWindow.prototype));
     ...
     * Setup of VM context.
     */
    [(_BrowserWindow_browserFrame = new WeakMap(), _BrowserWindow_innerWidth = new WeakMap(), _BrowserWindow_innerHeight = new WeakMap(), _BrowserWindow_outerWidth = new WeakMap(), _BrowserWindow_outerHeight = new WeakMap(), _BrowserWindow_devicePixelRatio = new WeakMap(), _a = PropertySymbol.captureEventListenerCount, _b = PropertySymbol.mutationObservers, _c = PropertySymbol.readyStateManager, PropertySymbol.location, PropertySymbol.history, PropertySymbol.navigator, PropertySymbol.screen, PropertySymbol.sessionStorage, PropertySymbol.localStorage, PropertySymbol.setupVMContext)]() {
