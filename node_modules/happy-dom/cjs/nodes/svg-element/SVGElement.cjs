...
class SVGElement extends Element_js_1.default {
    constructor() {
        ...
        this.onunload = null;
        // Internal properties
        this[_a] = new SVGElementNamedNodeMap_js_1.default(this);
        this[_b] = null;
        // Private properties
     ...
     */
    get dataset() {
        return (__classPrivateFieldSet(this, _SVGElement_dataset, __classPrivateFieldGet(this, _SVGElement_dataset, "f") ?? new Dataset_js_1.default(this), "f")).proxy;
    }
    /**
     * Returns style.
     *
